...
/**
 * Criteria class for the {@link com.franksiret.drones.domain.Medication} entity. This class is used
 * in {@link com.franksiret.drones.web.rest.MedicationResource} to receive all the possible filtering options from
...
public class MedicationCriteria implements Serializable, Criteria {
    ...
    @Override
    public int hashCode() {
        return Objects.hash(id, name, weight, code, droneId, distinct);
    }
